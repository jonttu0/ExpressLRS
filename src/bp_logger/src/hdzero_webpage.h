...
function start() {
  ...
  websock.onerror = function (evt) { console.log("WS error: ", evt); };
...
<body onload="javascript:start();"><div class="content">
  ...
  <fieldset><legend>ESP-NOW Clients</legend><div>
    ...
    <textarea id="espnowclients" class="valigntop"></textarea>
  ...
  <script>
    ...
    $id("espnowclients").addEventListener('keydown', espnowclients_autosize);
    function espnowclients_autosize(){
