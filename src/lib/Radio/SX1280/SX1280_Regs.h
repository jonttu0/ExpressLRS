...
#define SX1280_REG_LORA_SYNCWORD_MSB 0x944 // 0x944 ... 0x945
...
enum
{
    SX1280_STATUS_BUSY = 0x01,
    // 4:2 = Command status
    SX1280_STATUS_CMD_STATUS_SHIFT          = 2,
    SX1280_STATUS_CMD_STATUS_MASK           = 0x7 << SX1280_STATUS_CMD_STATUS_SHIFT,
    SX1280_STATUS_CMD_STATUS_CMD_OK         = 0x1 << SX1280_STATUS_CMD_STATUS_SHIFT,
    SX1280_STATUS_CMD_STATUS_DATA_AVAILABLE = 0x2 << SX1280_STATUS_CMD_STATUS_SHIFT,
    SX1280_STATUS_CMD_STATUS_CMD_TIMEOUT    = 0x3 << SX1280_STATUS_CMD_STATUS_SHIFT,
    SX1280_STATUS_CMD_STATUS_CMD_ERROR      = 0x4 << SX1280_STATUS_CMD_STATUS_SHIFT,
    SX1280_STATUS_CMD_STATUS_EXEC_FAIL      = 0x5 << SX1280_STATUS_CMD_STATUS_SHIFT,
    SX1280_STATUS_CMD_STATUS_TX_DONE        = 0x6 << SX1280_STATUS_CMD_STATUS_SHIFT,
    // 7:5 = Circuit mode
    SX1280_STATUS_MODE_SHIFT        = 5,
    SX1280_STATUS_MODE_MASK         = 0x7 << SX1280_STATUS_MODE_SHIFT,
    SX1280_STATUS_MODE_STDBY_RC     = 0x2 << SX1280_STATUS_MODE_SHIFT,
    SX1280_STATUS_MODE_STDBY_XOSC   = 0x3 << SX1280_STATUS_MODE_SHIFT,
    SX1280_STATUS_MODE_FS           = 0x4 << SX1280_STATUS_MODE_SHIFT,
    SX1280_STATUS_MODE_Rx           = 0x5 << SX1280_STATUS_MODE_SHIFT,
    SX1280_STATUS_MODE_Tx           = 0x6 << SX1280_STATUS_MODE_SHIFT,
};
...
typedef enum
{
    SX1280_RADIO_TICK_SIZE_15_625us = 0x00,
    SX1280_RADIO_TICK_SIZE_62_5us   = 0x01,
    SX1280_RADIO_TICK_SIZE_1ms      = 0x02,
    SX1280_RADIO_TICK_SIZE_4ms      = 0x03,
