...
static expresslrs_mod_settings_t DRAM_FORCE_ATTR ExpressLRS_AirRateConfig_128x_FLRC[] = {
    ...
    /* 1000Hz = single tx */
    {RADIO_FLRC, SX1280_FLRC_BR_0_650_BW_0_6, SX1280_FLRC_BT_1, SX1280_FLRC_CR_1_2, 1000, 150000u, 1000, 32, 1000, 1200, TLM_RATIO_NO_TLM, FHSS_2, OSD_MODE_1kHz_FLRC,  OTA_PAYLOAD_SX128x, 1}, // 0.49ms
#endif
    /*  500Hz = double tx @1kHz */
    {RADIO_FLRC, SX1280_FLRC_BR_0_650_BW_0_6, SX1280_FLRC_BT_1, SX1280_FLRC_CR_1_2, 1000, 250000u,  500, 32, 1000, 1200, TLM_RATIO_NO_TLM, FHSS_1, OSD_MODE_500Hz_FLRC, OTA_PAYLOAD_SX128x, 2}, // 0.49ms
    /*  250Hz = quad tx @1kHz */
    {RADIO_FLRC, SX1280_FLRC_BR_0_650_BW_0_6, SX1280_FLRC_BT_1, SX1280_FLRC_CR_1_2, 1000, 250000u,  250, 32, 1000, 1200, TLM_RATIO_NO_TLM, FHSS_2, OSD_MODE_250Hz_FLRC, OTA_PAYLOAD_SX128x, 4}, // 0.49ms
};
#endif
...
static expresslrs_mod_settings_t DRAM_FORCE_ATTR ExpressLRS_AirRateConfig_128x[] = {
    ...
    /* 500Hz */
    {RADIO_LORA, SX1280_LORA_BW_0800, SX1280_LORA_SF5, SX1280_LORA_CR_LI_4_6,  2000, 250000u, 500, 0b01100 /*12*/, 1000, 1200, TLM_RATIO_NO_TLM, FHSS_2, OSD_MODE_500Hz, OTA_PAYLOAD_SX128x, 1}, // 1.51ms
    /* 250Hz */
    {RADIO_LORA, SX1280_LORA_BW_0800, SX1280_LORA_SF6, SX1280_LORA_CR_LI_4_7,  4000, 250000u, 250, 0b01110 /*14*/, 1000, 1500, TLM_RATIO_1_64,   FHSS_2, OSD_MODE_250Hz, OTA_PAYLOAD_SX128x, 1}, // 3.33ms
    /* 125Hz */
    {RADIO_LORA, SX1280_LORA_BW_0800, SX1280_LORA_SF7, SX1280_LORA_CR_LI_4_7,  8000, 500000u, 125, 0b11001 /*18*/, 1000, 1500, TLM_RATIO_1_32,   FHSS_1, OSD_MODE_125Hz, OTA_PAYLOAD_SX128x, 1}, // 6.82ms
    /* 50Hz */
    {RADIO_LORA, SX1280_LORA_BW_0800, SX1280_LORA_SF8, SX1280_LORA_CR_LI_4_7, 20000, 750000u,  50, 0b11010 /*20*/, 1000, 2000, TLM_RATIO_1_16,   FHSS_1, OSD_MODE_50Hz,  OTA_PAYLOAD_SX128x, 1}, // 13.32ms
#else // 1600MHz BW
    /* 500Hz */
    {RADIO_LORA, SX1280_LORA_BW_1600, SX1280_LORA_SF6, SX1280_LORA_CR_LI_4_6,  2000, 250000u, 500, 0b01100 /*12*/, 1000, 1500, TLM_RATIO_1_128, FHSS_2, OSD_MODE_500Hz, OTA_PAYLOAD_SX128x, 1}, // 1.35ms
    /* 250Hz */
    {RADIO_LORA, SX1280_LORA_BW_1600, SX1280_LORA_SF7, SX1280_LORA_CR_LI_4_7,  4000, 250000u, 250, 0b01110 /*14*/, 1000, 1500, TLM_RATIO_1_64,  FHSS_2, OSD_MODE_250Hz, OTA_PAYLOAD_SX128x, 1}, // 3.10ms
    /* 125Hz */
    {RADIO_LORA, SX1280_LORA_BW_1600, SX1280_LORA_SF8, SX1280_LORA_CR_LI_4_7,  8000, 500000u, 125, 0b11010 /*20*/, 1000, 2000, TLM_RATIO_1_32,  FHSS_1, OSD_MODE_125Hz, OTA_PAYLOAD_SX128x, 1},
    /* 50Hz */
    {RADIO_LORA, SX1280_LORA_BW_1600, SX1280_LORA_SF9, SX1280_LORA_CR_LI_4_7, 20000, 750000u,  50, 0b11010 /*20*/, 1000, 2500, TLM_RATIO_1_16,  FHSS_1, OSD_MODE_50Hz,  OTA_PAYLOAD_SX128x, 1},
...
static expresslrs_mod_settings_t DRAM_FORCE_ATTR ExpressLRS_AirRateConfig_128x_VANILLA[] = {
    /* 500Hz */
    {RADIO_LORA, SX1280_LORA_BW_0800, SX1280_LORA_SF5, SX1280_LORA_CR_LI_4_6,  2000, 250000u, 500, 12, 1000, 1000, TLM_RATIO_NO_TLM, FHSS_4, OSD_MODE_500Hz, 8, 1}, // 1.51ms
    /* 250Hz */
    {RADIO_LORA, SX1280_LORA_BW_0800, SX1280_LORA_SF6, SX1280_LORA_CR_LI_4_7,  4000, 250000u, 250, 12, 1000, 1000, TLM_RATIO_NO_TLM, FHSS_4, OSD_MODE_250Hz, 8, 1}, // 3.33ms
    /* 150Hz */
    {RADIO_LORA, SX1280_LORA_BW_0800, SX1280_LORA_SF7, SX1280_LORA_CR_LI_4_7,  6666, 500000u, 150, 12, 1000, 1500, TLM_RATIO_NO_TLM, FHSS_4, OSD_MODE_125Hz, 8, 1}, // 6.82ms
    /* 50Hz */
    {RADIO_LORA, SX1280_LORA_BW_0800, SX1280_LORA_SF9, SX1280_LORA_CR_LI_4_6, 20000, 750000u,  50, 12, 1000, 2000, TLM_RATIO_NO_TLM, FHSS_2, OSD_MODE_50Hz,  8, 1}, // 13.32ms
};
...
static expresslrs_mod_settings_t DRAM_FORCE_ATTR ExpressLRS_AirRateConfig_127x[] = {
    /* 200Hz */
    {RADIO_LORA, SX127X_BW_500_00_KHZ,  SX127X_SF_6, SX127X_CR_4_7,   5000, 250000u, 200, 8, 1000, 1000, TLM_RATIO_1_64, FHSS_1, OSD_MODE_200Hz, OTA_PAYLOAD_SX127x, 1}, // 4.38ms
    /* 100Hz */
    {RADIO_LORA, SX127X_BW_500_00_KHZ,  SX127X_SF_7, SX127X_CR_4_8,  10000, 500000u, 100, 8, 1000, 1500, TLM_RATIO_1_32, FHSS_1, OSD_MODE_100Hz, OTA_PAYLOAD_SX127x, 1}, // 9.28ms
    /* 50Hz */
    {RADIO_LORA, SX127X_BW_500_00_KHZ,  SX127X_SF_8, SX127X_CR_4_8,  20000, 750000u,  50, 8, 1000, 2000, TLM_RATIO_1_16, FHSS_1, OSD_MODE_50Hz,  OTA_PAYLOAD_SX127x, 1}, // 18.56ms
};
#endif /* RADIO_SX127x */
