...
#else
    /* 500Hz */
    {RADIO_FLRC, SX1280_FLRC_BR_0_650_BW_0_6, SX1280_FLRC_BT_1, SX1280_FLRC_CR_1_2, 2000, 250000u, 500, 32, 1000, 750, TLM_RATIO_NO_TLM, FHSS_2, OSD_MODE_500Hz_FLRC, OTA_PAYLOAD_SX128x}, // 0.49ms
#endif
};
#endif
...
static expresslrs_mod_settings_t DRAM_FORCE_ATTR ExpressLRS_AirRateConfig_128x[] = {
    ...
    /* 500Hz */
    {RADIO_LORA, SX1280_LORA_BW_0800, SX1280_LORA_SF5, SX1280_LORA_CR_LI_4_6,  2000, 250000u, 500, 0b01100 /*12*/, 1000,  750, TLM_RATIO_NO_TLM, FHSS_2, OSD_MODE_500Hz, OTA_PAYLOAD_SX128x}, // 1.51ms
    /* 250Hz */
    {RADIO_LORA, SX1280_LORA_BW_0800, SX1280_LORA_SF6, SX1280_LORA_CR_LI_4_7,  4000, 250000u, 250, 0b01110 /*14*/, 1000,  750, TLM_RATIO_1_64,   FHSS_1, OSD_MODE_250Hz, OTA_PAYLOAD_SX128x}, // 3.33ms
    /* 125Hz */
    {RADIO_LORA, SX1280_LORA_BW_0800, SX1280_LORA_SF7, SX1280_LORA_CR_LI_4_7,  8000, 500000u, 125, 0b11001 /*18*/, 1000, 1200, TLM_RATIO_1_32,   FHSS_1, OSD_MODE_125Hz, OTA_PAYLOAD_SX128x}, // 6.82ms
    /* 50Hz */
    {RADIO_LORA, SX1280_LORA_BW_0800, SX1280_LORA_SF8, SX1280_LORA_CR_LI_4_7, 20000, 750000u,  50, 0b11010 /*20*/, 1000, 1500, TLM_RATIO_1_16,   FHSS_1, OSD_MODE_50Hz,  OTA_PAYLOAD_SX128x}, // 13.32ms
#else // 1600MHz BW
    /* 800Hz */
...
static expresslrs_mod_settings_t DRAM_FORCE_ATTR ExpressLRS_AirRateConfig_127x[] = {
    /* 200Hz */
    {RADIO_LORA, BW_500_00_KHZ,  SF_6, CR_4_7,   5000, 250000u, 200, 8, 1000, 1000, TLM_RATIO_1_64, FHSS_1, OSD_MODE_200Hz, OTA_PAYLOAD_SX127x}, // 4.38ms
    /* 100Hz */
    {RADIO_LORA, BW_500_00_KHZ,  SF_7, CR_4_8,  10000, 500000u, 100, 8, 1000, 1500, TLM_RATIO_1_32, FHSS_1, OSD_MODE_100Hz, OTA_PAYLOAD_SX127x}, // 9.28ms
    /* 50Hz */
    {RADIO_LORA, BW_500_00_KHZ,  SF_8, CR_4_8,  20000, 750000u,  50, 8, 1000, 2000, TLM_RATIO_1_16, FHSS_1, OSD_MODE_50Hz,  OTA_PAYLOAD_SX127x}, // 18.56ms
};
#endif /* RADIO_SX127x */
