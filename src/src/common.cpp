...
static expresslrs_mod_settings_t DRAM_FORCE_ATTR ExpressLRS_AirRateConfig_128x_FLRC[] = {
    ...
    /* 1000Hz */
    {RADIO_FLRC, SX1280_FLRC_BR_0_650_BW_0_6, SX1280_FLRC_BT_1, SX1280_FLRC_CR_1_2, 1000, 150000u, 1000, 32, 1000, 1700, TLM_RATIO_NO_TLM, FHSS_8, OSD_MODE_1kHz_FLRC,  OTA_PAYLOAD_SX128x}, // 0.49ms
#endif
    /*  500Hz */
    {RADIO_FLRC, SX1280_FLRC_BR_0_650_BW_0_6, SX1280_FLRC_BT_1, SX1280_FLRC_CR_1_2, 2000, 250000u,  500, 32, 1000, 1200, TLM_RATIO_NO_TLM, FHSS_4, OSD_MODE_500Hz_FLRC, OTA_PAYLOAD_SX128x}, // 0.49ms
};
#endif
...
static expresslrs_mod_settings_t DRAM_FORCE_ATTR ExpressLRS_AirRateConfig_128x[] = {
    ...
    /* 500Hz */
    {RADIO_LORA, SX1280_LORA_BW_0800, SX1280_LORA_SF5, SX1280_LORA_CR_LI_4_6,  2000, 250000u, 500, 0b01100 /*12*/, 1000, 1200, TLM_RATIO_NO_TLM, FHSS_4, OSD_MODE_500Hz, OTA_PAYLOAD_SX128x}, // 1.51ms
    /* 250Hz */
    {RADIO_LORA, SX1280_LORA_BW_0800, SX1280_LORA_SF6, SX1280_LORA_CR_LI_4_7,  4000, 250000u, 250, 0b01110 /*14*/, 1000, 1500, TLM_RATIO_1_64,   FHSS_4, OSD_MODE_250Hz, OTA_PAYLOAD_SX128x}, // 3.33ms
    /* 125Hz */
